...
public interface ICloudRenderHandler {
    void render(int ticks, float partialTicks, MatrixStack matrixStack, ClientWorld world, MinecraftClient mc, double viewEntityX, double viewEntityY, double viewEntityZ);
}

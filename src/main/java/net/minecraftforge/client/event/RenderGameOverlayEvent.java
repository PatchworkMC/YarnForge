...
public class RenderGameOverlayEvent extends Event
{
    ...
    public RenderGameOverlayEvent(MatrixStack mStack, float partialTicks, Window window)
    {
        this.mStack = mStack;
    ...
    public static class BossInfo extends Pre
    {
        ...
        public BossInfo(MatrixStack mStack, RenderGameOverlayEvent parent, ElementType type, ClientBossBar bossInfo, int x, int y, int increment)
        {
            super(mStack, parent, type);

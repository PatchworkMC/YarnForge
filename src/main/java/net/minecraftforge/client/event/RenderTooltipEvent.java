...
public abstract class RenderTooltipEvent extends net.minecraftforge.eventbus.api.Event
{
    ...
    protected final List<? extends StringVisitable> lines;
    protected final MatrixStack matrixStack;
    protected int x;
    protected int y;
    protected TextRenderer fr;

    public RenderTooltipEvent(@Nonnull ItemStack stack, @Nonnull List<? extends StringVisitable> lines, MatrixStack matrixStack, int x, int y, @Nonnull TextRenderer fr)
    {
        this.stack = stack;
     ...
     */
    @Nonnull
    public List<? extends StringVisitable> getLines()
    {
        return lines;
    }
    ...
    public static class Pre extends RenderTooltipEvent
    {
        ...
        public Pre(@Nonnull ItemStack stack, @Nonnull List<? extends StringVisitable> lines, MatrixStack matrixStack, int x, int y, int screenWidth, int screenHeight, int maxWidth, @Nonnull TextRenderer fr)
        {
    ...
    protected static abstract class Post extends RenderTooltipEvent
    {
        ...
        public Post(@Nonnull ItemStack stack, @Nonnull List<? extends StringVisitable> textLines, MatrixStack matrixStack,int x, int y, @Nonnull TextRenderer fr, int width, int height)
        {
    ...
    {
        public PostBackground(@Nonnull ItemStack stack, @Nonnull List<? extends StringVisitable> textLines, MatrixStack matrixStack, int x, int y, @Nonnull TextRenderer fr, int width, int height)
    ...
    {
        public PostText(@Nonnull ItemStack stack, @Nonnull List<? extends StringVisitable> textLines, MatrixStack matrixStack, int x, int y, @Nonnull TextRenderer fr, int width, int height)
            { super(stack, textLines, matrixStack, x, y, fr, width, height); }
    }
    ...
    public static class Color extends RenderTooltipEvent
    {
        ...
        public Color(@Nonnull ItemStack stack, @Nonnull List<? extends StringVisitable> textLines, MatrixStack matrixStack, int x, int y, @Nonnull TextRenderer fr, int background, int borderStart,
                int borderEnd)
        {
            super(stack, textLines, matrixStack, x, y, fr);

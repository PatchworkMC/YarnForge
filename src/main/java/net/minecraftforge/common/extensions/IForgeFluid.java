...
public interface IForgeFluid
{
     ...
     */
    default boolean isEntityInside(FluidState state, WorldView world, BlockPos pos, Entity entity, double yToTest, SetTag<Fluid> tag, boolean testingHead)
    {
        return state.isIn(tag) && yToTest < (double)(pos.getY() + state.getHeight(world, pos) + 0.11111111F);
    }
    ...
    default float getExplosionResistance(FluidState state, BlockView world, BlockPos pos, Explosion explosion)
    {
